...
import com.infilos.sampler.layout.MultiformControlProvider;
...
public class TableProvider implements MultiformControlProvider {
    private static final ObservableList<String> list = 
        FXCollections.observableList(List.of("a", "b", "c"));
